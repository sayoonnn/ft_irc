...
#define RPL_KICK(userinfo, channel, kickuser, reason)			((userinfo) + " KICK " + (channel) + " " + (kickuser) + " :" + (reason) + "\n")
#define RPL_PART(userinfo, channel, reason)						((userinfo) + " PART " + (channel) + " :" + (reason) + "\n")
